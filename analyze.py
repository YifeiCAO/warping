...
def distance_ratio(reps, dists, args):
    ...
    for rep_name in rep_names:
        ...
        ratio = ave_incong_dist / ave_cong_dist
...
def ttest_exclusion(reps, dists, args):
    ...
    for idx in range(n_states):
        ...
        for rep_name in rep_names:
            ...
            results_each[rep_name].append({'t_statistic': t, 'p_value': p})
    ...
    for rep_name in rep_names:
        ...
        t, p = ttest_ind(rep_dists_cong, rep_dists_incong)
        # results_each[rep_name] = {'t_statistic': t, 'p_value': p}
        results_ex_bl_tr[rep_name] = {'t_statistic': t, 'p_value': p}
    ...
    for rep_name in rep_names:
        ...
        results_ex_corners[rep_name]= {'t_statistic': t, 'p_value': p}
